...
class CallimMailMail(models.Model):
        ...
        email_partner_bcc = fields.Many2many('res.partner', 'message_partnerbcc_rel','mailid','partner_id', domain=lambda self: [('category_id.name', '=', 'Contact CC')], string="Cci", help='Carbon copy message recipients')
